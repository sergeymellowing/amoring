...
class Dummy {
    static let users = [
        User(id: "1", name: "Eugene Krabs", birthDate: "2000-08-08".toDate(), bio: "저희 3명이고, 테이블 잡음, 술 있음", gender: "FEMALE", fakeImage: "person-0"),
        User(id: "2", name: "SpongeBob SquarePants", birthDate: "2001-08-08".toDate(), bio: "저희 3명이고, 테이블 잡음, 술 있음", gender: "MALE", fakeImage: "person-1"),
